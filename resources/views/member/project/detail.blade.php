                        ...
                        <div class="card-body">
                            ...
                            {{-- <div class="button-items text-end mb-1">
                                <a href="{{ route('member.project.create') }}"
                                    ...
                                    <i class="fas fa-tasks font-size-16 align-middle"></i> Create Task
                                </a>
                            </div> --}}
                            <table class="table table-striped mb-0">
                                ...
                                <tr>
                                    ...
                                    <td>Created at</td>
                                    <td>{{ $project->created_at ? $project->created_at->format('d M Y') : $project->created_at }}
                                    </td>
                                </tr>

                                <tr>
                                    <td>Last updated</td>
                                    <td>{{ $project->updated_at ? $project->updated_at->format('d M Y') : $project->updated_at }}
                                    </td>
                                    <td>Active</td>
                                    <td>
                            ...
                            @foreach ($project->tasks as $task)
                                <table class="table table-striped mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>Last updated</td>
                                        <td>{{ $task->updated_at ? $task->updated_at->format('d M Y') : $task->updated_at }}
                                        </td>
                    ...
                    <div class="card">
                                    ...
                                    @foreach ($team->users as $user)
                                        <tr>
                                            ...
                                            @if ($user->is_leader == 1 && $user->role_id == 2)
                                                <td>
                                                    {{ $user->name ? $user->name : '' }} <i class="fas fa-user-tie fa-lg"
                                                        style="color: #3b5de7;"></i></td>
                                            @else
                        ...
                        <div class="col-md-12 button-items text-end mb-1">
                            <a href="{{ route('member.project') }}"
                                class="col-md-2 btn btn-outline-secondary waves-effect">
                                Back
                            </a>
                        </div>
                    </div>
