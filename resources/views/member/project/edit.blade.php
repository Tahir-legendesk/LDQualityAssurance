        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action={{ url('/member/project/' . $project->id . '/update') }} method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3 row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Name</label>
                                    <div class="col-md-4">
                                        <input class="form-control" type="text" name="name" placeholder="Jhon deo"
                                            id="example-text-input" value="{{$project->name}}">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" type="text" name="comments"
                                            ...
                                            id="example-search-input" value="{{$project->comments}}">
                                        <ul class="parsley-errors-list filled" id="parsley-id-39">
                                            <li class="parsley-required">
                                                @error('comments')
                                ...
                                <div class="mb-3 row">
                                    <label for="example-search-input" class="col-md-2 col-form-label">Late Reason</label>
                                    <div class="col-md-4">
                                        <input class="form-control" type="text" name="late_reason"
                                            placeholder="simply dummy text of the printing and typesetting industry"
                                            id="example-search-input" value="{{$project->late_reason}}">
                                    </div>
