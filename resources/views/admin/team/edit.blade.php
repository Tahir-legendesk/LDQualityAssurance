        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="page-title mb-0 font-size-18">update team</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action={{ url('/admin/teams/' . $team->id . '/update') }} method="POST"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" type="text" name="name" placeholder="Jhon deo"
                                            value="{{ $team->name }}" id="example-text-input">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-check-input" checked="checked" name="is_active"
                                            value="{{ old($team->is_active) }}" type="checkbox">
                                    </div>
                                </div>
